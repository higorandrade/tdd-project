...
class NewVisitorTest(FunctionalTest):
    ...
    def test_can_start_a_list_for_one_user(self): 
        ...
        FunctionalTest.wait_for_row_in_list_table(self, '1: Estudar testes funcionais')
        ...
        FunctionalTest.wait_for_row_in_list_table(self, '1: Estudar testes funcionais')
        FunctionalTest.wait_for_row_in_list_table(self, '2: Estudar testes de unidade')
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        inputbox.send_keys(Keys.ENTER)
        FunctionalTest.wait_for_row_in_list_table(self, '1: Comprar leite')
